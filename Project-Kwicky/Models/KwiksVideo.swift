...
struct KwiksVideo {
    ...
    static let videoExampleFour = KwiksVideo(title: "Jedi Survivor Secret Missions. Heavy Spoilers!", uploadedFrom: User.exampleUserFour, viewers: 9999, deleteLaterImage: UIImage(named: "PlaceholderVideoImage04"))
    ...
    static let liveExampleFour = KwiksVideo(title: "Jedi Survivor Secret Missions. Heavy Spoilers!", uploadedFrom: User.exampleUserFour, isLive: true, viewers: 9999, deleteLaterImage: UIImage(named: "PlaceholderVideoImage04"))
