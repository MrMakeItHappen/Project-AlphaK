...
class WalletBalancePagination : BaseView {
    ...
    var balanceLabel : UILabel = {
        ...
        hfl.textColor = UIColor.white
        hfl.textAlignment = .center
        hfl.font = UIFont.segoeUIBold(size: 32)
    ...
    var priceContainerLabel : UILabel = {
        ...
        hfl.textAlignment = .center
        hfl.font = UIFont.segoeUIRegular(size: 12)
    ...
    let circlelabel : UILabel = {
        ...
        cl.font = UIFont.segoeUIBold(size: 2)
        cl.numberOfLines = 3
    ...
    func triggerRefs() {//no lazy
        self.addMoneyButton.addTarget(self, action: #selector(self.handleAddMoneyButton(sender:)), for: .touchUpInside)
        self.cashOutButton.addTarget(self, action: #selector(self.handleCashOutButton(sender:)), for: .touchUpInside)
    }
    ...
    @objc func handleCashOutButton(sender:UIButton) {
        self.walletController?.handleCashOutButton(sender:sender)
    }
    @objc func handleAddMoneyButton(sender:UIButton) {
        self.walletController?.handleAddMoneyButton(sender:sender)
    }
